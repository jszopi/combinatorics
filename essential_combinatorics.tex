...
\foreignlanguage{polish}{\textbf{PL}: permutacje bez powtórzeń.}
...
\foreignlanguage{polish}{\textbf{PL}: wariacje z powtórzeniami.}
...
\foreignlanguage{polish}{\textbf{PL}: wariacje bez powtórzeń.}
...
\foreignlanguage{polish}{\textbf{PL}: permutacje z powtórzeniami.}
